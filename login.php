...
<div class="flex flex-col items-center justify-center min-h-screen bg-blue-950 text-white" data-aos="zoom-in">
    <form method="POST" class="bg-blue-900 p-6 rounded shadow-xl w-full max-w-sm">
        ...
        <input type="text" name="email" placeholder="Email" required class="mb-3 w-full px-3 py-2 rounded bg-blue-800 text-white" />
        ...
        <button type="submit" class="w-full bg-blue-700 py-2 rounded hover:bg-blue-800">Login</button>
    </form>
</div>
